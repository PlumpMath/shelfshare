...
get the app created:
    ...
    $ heroku apps:create shelfshare
    Creating shelfshare... done, stack is cedar
    http://shelfshare.herokuapp.com/ | git@heroku.com:shelfshare.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://shelfshare.herokuapp.com deployed to Heroku

    To git@heroku.com:shelfshare.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://shelfshare.herokuap.com
    ["Hello" :from Heroku]
